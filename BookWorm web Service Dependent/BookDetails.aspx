        ...
        <table style="width: 100%; height: 320px;">
            ...
            <tr>
                ...
                <td align ="center" class="auto-style99" style="vertical-align: top; ">
                    ...
                    <asp:GridView ID="SimilarBooksGV" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="268px" ShowHeader="False" Width="145px" DataKeyNames="BookId" OnSelectedIndexChanged="SimilarBooksGV_SelectedIndexChanged">
