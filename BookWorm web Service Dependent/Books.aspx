        ...
        <table style="width: 100%; height: 434px;">
            ...
            <tr>
                ...
                <td class="auto-style9" style="text-align: center; vertical-align: top;">
                    <asp:GridView ID="MainGridView" runat="server" AutoGenerateColumns="False" Height="260px" Width="100%" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="MainGridView_SelectedIndexChanged" DataKeyNames="BookId" PageSize="6" OnPageIndexChanging="MainGridView_PageIndexChanging">
