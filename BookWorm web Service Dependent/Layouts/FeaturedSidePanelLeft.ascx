...
<asp:Panel ID="Panel1" runat="server" Height="493px" Width="247px" HorizontalAlign="Center" BorderColor="#0033CC">
    ...
    <asp:GridView ID="FeaturedGV" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="BookId" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowHeader="False" Width="247px">
