        ...
        <table style="width: 100%; height: 697px;">
            ...
            <tr>
                ...
                <td align ="center" class="auto-style1" style="vertical-align: top">
                    ...
                    <asp:GridView ID="SubmittedByYouGv" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="BookId" ForeColor="#333333" GridLines="None" PageSize="3" ShowHeader="False" OnSelectedIndexChanged="submittedByYouGv_SelectedIndexChanged">
