        ...
        <table style="width: 100%; height: 235px;">
            ...
            <tr>
                ...
                <td align ="center" style="width: 25%; vertical-align: top;">
                    <asp:GridView ID="SubmittedGV" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="BookId" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="191px" ShowHeader="False" Width="264px" AllowCustomPaging="True" AllowPaging="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="3">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BookWormConnectionString %>" SelectCommand="SELECT [BookId], [BookImageUrl], [BookName] FROM [BookInformation]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
